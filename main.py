...
from components.commit_handler import GoogleTranslationCommitHandler
...
class Core(LoggingBase):
    def __init__(self, config: Dict):
        ...
        self.data_storage.register_commit_handler('google', GoogleTranslationCommitHandler())
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--language', dest='language', type=str, default="en")
    ...
    app_config['language'] = args.language
